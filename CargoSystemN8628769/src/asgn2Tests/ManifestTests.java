...
public class ManifestTests {
	...
	private CargoManifest cm2;

	private CargoManifest cm3;
    ...
    public void testInvalidNumStacksParameter() throws ManifestException {  
		...
		int maxHeight = 3;
		int maxWeight = 30;
		setCm(new CargoManifest(numStacks, maxHeight, maxWeight));
    }  
    ...
    public void testInvalidMaxHeightParameter() throws ManifestException {  
		...
		int maxHeight = -1;
		int maxWeight = 30;
		setCm2(new CargoManifest(numStacks, maxHeight, maxWeight));
    }  
    ...
    public void testInvalidMaxWeightParameter() throws ManifestException {  
		...
		int maxHeight = 3;
		int maxWeight = -3;
		setCm3(new CargoManifest(numStacks, maxHeight, maxWeight));
    }  
	...
	public CargoManifest getCm() {
		return cm;
	}

	public void setCm(CargoManifest cm) {
		this.cm = cm;
	}

	public CargoManifest getCm2() {
		return cm2;
	}

	public void setCm2(CargoManifest cm2) {
		this.cm2 = cm2;
	}

	public CargoManifest getCm3() {
		return cm3;
	}

	public void setCm3(CargoManifest cm3) {
		this.cm3 = cm3;
	}
